...
- If feasible, create standardized cleaning functions (in a [package](/2019/02/27/upgrading-to-r-4-write-a-package/)!) so that variable names are the same across different projects.
