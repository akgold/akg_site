...
Whether you're a team leader trying to take your group to the next level, or an indvidual contributor just trying to use more R (or get your organization to do so), it's really important to find other people to join you on the journey. If you manage to find the right people, they'll become a crack R team (relatively) quickly or will help you upgrade your own skills. In my experience, there are a few factors that can help drive the team from here (a sadly R-less land) to the magical place where free range R code runs all day, the data is always clean, and syntax errors are nonexistent. 
