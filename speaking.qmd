...
bind_cols(
  tibble::tribble(
    ...
    "2024-09-05", "Posit Data Science Hangout", "https://youtu.be/9Nqfyv9Qyr4?feature=shared", NA, 
    "2024-10-22", "Ken's Nearest Neighbors Podcast", "https://lnkd.in/gcgseF2Y", NA,
    "2024-10-30", "R Gov: Everything You Never Wanted to Know About Auth", "https://www.youtube.com/watch?v=GyWoiaAgsbU", NA
  ), 
  tibble::tribble(
    ~Video, 
    NA,
    ...
    "https://www.youtube.com/watch?v=WB1Ob_2ccG8&list=PLlzRFZmxVl9SMqlb4nCaeKonHRyGZfrn9&index=8", 
    "https://youtu.be/9Nqfyv9Qyr4?feature=shared", 
    "https://lnkd.in/gcgseF2Y", 
    "https://www.youtube.com/watch?v=GyWoiaAgsbU"
  )
) %>%
  dplyr::transmute(
    Date,
