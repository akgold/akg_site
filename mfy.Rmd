...
Later, I moved back into an individual contributor role on the Solutions
Engineering team at RStudio. I started writing this essay around the
time I went to RStudio.
...
stretching management had required of me.
...
weren't good enough, and my review could have caught it. So I decided
that all of the team's code would be checked into git every night and I
would review it.
...
And moreover, the new rules provoked the fear of being stupid or
lacking. One of the main rules was that code had to be checked into git
every night. From my own experience, I knew how hard git is. It is so
hard to develop a reliable mental model, and it feels like all the code
might go poof with any action.[^1] And I told my team they had to use it
constantly, with no help or guidance from me.
...
Eventually, I grasped that the main thing I was actually doing was
...
I actually really liked this division, as it gave everyone the
opportunity to acquire more mentors and mentorship. It was also nice in
that career management conversations were truly about career -- because
I wasn't close enough to have tactical conversations about day-to-day
work.
